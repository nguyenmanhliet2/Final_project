...
<body class="horizontal-layout horizontal-menu blank-page navbar-floating footer-static  " data-open="hover" data-menu="horizontal-menu" data-col="blank-page">
    <!-- BEGIN: Content-->
    <div class="app-content content" id="adminLoginPage">
                            ...
                            <div class="card-body">
                                ...
                                <form class="auth-login-form mt-2" action="index.html" method="POST">
                                    <div class="mb-1">
                                        ...
                                        <input type="email" v-model='listLogin.email' class="form-control" placeholder="name@example.com" aria-describedby="login-email" tabindex="1" autofocus />
                                    </div>
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div class="input-group input-group-merge form-password-toggle">
                                            <input type="password" v-model='listLogin.password' class="form-control form-control-merge" id="login-password" name="login-password" tabindex="2" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="login-password" />
                                    ...
                                    <button class="btn btn-primary w-100" type="button" v-on:click="createAdmin()" tabindex="4">Sign in</button>
                                </form>
    ...
    <!-- BEGIN: Page JS-->
    <script src="/stack/app-assets/js/scripts/pages/auth-login.js"></script>
    <!-- END: Page JS-->

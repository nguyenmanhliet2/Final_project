        ...
        <div class="blog-page mt-100">
            <div class="blog-page-wrapper">
                <div class="container">
                    <div class="row">
                        <template>
                            <div class="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-duration="700" v-for="(value, key) in listPost">
                                <div class="article-card bg-transparent p-0 shadow-none">
                                    <a class="article-card-img-wrapper" v-bind:href="'/blogDetailPage/'+ value.id">
                                        <img v-bind:src="value.hinh_anh" alt="img" class="article-card-img rounded">
                                    </a>
                                    <p class="article-card-published text_12 d-flex align-items-center">
                                        <span class="article-date d-flex align-items-center">
                                            ...
                                            <span class="ms-2"> @{{ formatDate(value.created_at) }}</span>
                                        </span>
                                        <span class="article-author d-flex align-items-center ms-4">
                                            ...
                                            <span class="ms-2">@{{ value.last_name }}</span>
                                        </span>
                                    </p>

                            ...
                            <div class="product-card">
                                <div class="product-card-img">
                                    ...
                                    <div class="product-badge">
                                        <span
                                            class="badge-label badge-percentage rounded">{{ number_format((($value_product->price_product - $value_product->sales_price_product) / $value_product->price_product) * 100, 2) }}
                                            %</span>
                                    </div>

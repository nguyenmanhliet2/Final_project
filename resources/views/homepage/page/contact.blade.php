                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="contact-item">
                                ...
                                <div class="contact-details">
                                    ...
                                    <a class="contact-info" target="_blank" href="mailto:nguyenmanhliet2@gmail.com">nguyenmanhliet2@gmail.com</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="contact-item">
                                ...
                                <div class="contact-details">
                                    <h2 class="contact-title">My Home</h2>
                                    <p class="contact-info">196 Trần Cao Vân, Đà Nẵng</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="contact-item">
                                ...
                                <div class="contact-details">
                                    ...
                                    <a class="contact-info" href="tel:(201) 555-0124">0783323888</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div  class="contact-form">
                            <div class="row">
                                <div class="col-md-12 col-12">
                                    <fieldset>
                                        <textarea v-model="contact.message" cols="20" rows="6" placeholder="Write your message here*"></textarea>
                                    </fieldset>
                                    <button type="submit" v-on:click="postMess()" class="position-relative review-submit-btn contact-submit-btn">SEND MESSAGE</button>
                                </div>
                            </div>
                        </div>
                    </div>
